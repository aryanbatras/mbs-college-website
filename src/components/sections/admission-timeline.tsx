      ...
      <div className="page-container section-spacing">
          ...
          {TIMELINE_STEPS.map((step, i) => (
            ...
            >
              <div className={`flex-1 md:w-1/2 ${i % 2 === 0 ? "md:pr-12 md:text-right" : "md:pl-12"}`}>
                <div className="bg-gray-100/5 p-5">
                  <div className={`flex items-center gap-2 mb-2 ${i % 2 === 0 ? "md:justify-end" : ""}`}>
                    <span className="text-[10px] font-bold tracking-wider uppercase text-gray-400">{step.date}</span>
                  </div>
              ...
              <div className="absolute left-6 md:left-1/2 -translate-x-1/2 size-12 flex items-center justify-center bg-white border-2 border-gray-200 z-10">
                <step.icon className="text-gray-400 text-lg" />
              </div>
        ...
        <div className="text-center mt-12">
          <a
            ...
            className="inline-flex items-center gap-2 px-6 py-3 text-sm font-bold bg-gray-100 text-[#00274C] hover:bg-[#00274C] hover:text-gray-400 transition-colors"
          >
