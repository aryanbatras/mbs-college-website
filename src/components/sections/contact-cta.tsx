...
export function ContactCTA({ config }: ContactCTAProps) {
  return (
    <section className="bg-ink text-paper" aria-label="Contact information">
      <div className="page-container section-spacing">
        <div className="max-w-2xl mx-auto text-center">
          <p className="text-sm font-medium tracking-widest uppercase text-accent mb-3">
            Get in Touch
          </p>
          <h2 className="text-2xl md:text-3xl font-semibold tracking-tight text-paper mb-4">
            Ready to Begin Your Journey?
          </h2>
          <p className="text-base text-paper/60 leading-relaxed mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-14 pt-10 border-t border-paper/10">
