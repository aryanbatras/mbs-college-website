          ...
          <div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4">
                <div className="size-12 flex items-center justify-center bg-[#FFCB05] shrink-0">
            ...
            <div className="flex items-center gap-4 mt-10">
              {config.social.facebook && (
                <a href={config.social.facebook} target="_blank" rel="noopener noreferrer" className="size-10 flex items-center justify-center bg-[#00274C] text-[#FFCB05] hover:bg-[#1E406B] transition-all" aria-label="Facebook">
                  <FaFacebookF className="text-sm" />
                </a>
              )}
              {config.social.instagram && (
                <a href={config.social.instagram} target="_blank" rel="noopener noreferrer" className="size-10 flex items-center justify-center bg-[#00274C] text-[#FFCB05] hover:bg-[#1E406B] transition-all" aria-label="Instagram">
                  <FaInstagram className="text-sm" />
                </a>
              )}
              {config.social.linkedin && (
                <a href={config.social.linkedin} target="_blank" rel="noopener noreferrer" className="size-10 flex items-center justify-center bg-[#00274C] text-[#FFCB05] hover:bg-[#1E406B] transition-all" aria-label="LinkedIn">
            ...
            {submitted ? (
              ...
              <form onSubmit={handleSubmit} className="bg-[#00274C] p-8 md:p-12">
                ...
                <div className="space-y-5">
                  <div>
                    <label htmlFor="name" className="block text-sm font-bold text-[#FFCB05] mb-2">
                      Your Name
                    </label>
                    <input
                      type="text"
                      ...
                      required
                      className="w-full px-4 py-3 border-2 border-[#FFCB05]/30 bg-white text-[#00274C] text-sm focus:outline-none focus:border-[#FFCB05] transition-colors"
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                    <div>
                      <label htmlFor="email" className="block text-sm font-bold text-[#FFCB05] mb-2">
                        Email Address
                      </label>
                      <input
                        type="email"
                    ...
                    <div>
                      <label htmlFor="phone" className="block text-sm font-bold text-[#FFCB05] mb-2">
                        Phone Number
                      </label>
                      <input
                        type="tel"
                  ...
                  <div>
                    <label htmlFor="subject" className="block text-sm font-bold text-[#FFCB05] mb-2">
                      Subject
                    </label>
                    <select
                      id="subject"
                  ...
                  <div>
                    <label htmlFor="message" className="block text-sm font-bold text-[#FFCB05] mb-2">
                      Your Message
                    </label>
                    <textarea
                      id="message"
                      ...
                      required
                      rows={5}
                      className="w-full px-4 py-3 border-2 border-[#FFCB05]/30 bg-white text-[#00274C] text-sm focus:outline-none focus:border-[#FFCB05] transition-colors resize-none"
                  ...
                  <button
                    type="submit"
                    disabled={sending}
                    className="w-full flex items-center justify-center gap-2 bg-[#FFCB05] text-[#00274C] px-8 py-4 text-sm font-bold hover:bg-white transition-colors disabled:opacity-60"
                  >
                    {sending ? (
                      "Opening email..."
                    ) : (
