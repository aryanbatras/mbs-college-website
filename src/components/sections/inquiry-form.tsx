    ...
    <div>
      ...
      <div className="flex items-center justify-between mt-8 pt-6 border-t border-[#E5E7EB]">
        ...
        {currentStep < 4 ? (
          <button
            onClick={nextStep}
            className="flex items-center gap-2 px-6 py-2.5 text-sm font-bold bg-[#00274C] text-white hover:bg-[#1E406B] transition-colors"
          >
            Continue
          ...
          <button
            ...
            className="flex items-center gap-2 px-6 py-2.5 text-sm font-bold bg-[#FFCB05] text-[#00274C] hover:bg-[#FFC107] transition-colors"
          >
