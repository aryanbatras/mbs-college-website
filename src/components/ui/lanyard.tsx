...
// 1x1 transparent pixel for fallback
const BLANK_PIXEL =
...
function Band({
  ...
  // Composite front/back images into card texture atlas
  ...
  const materialsTyped = materials as any;
    ...
    <>
      <group position={[0, 4, 0]}>
        ...
        >
          ...
          >
            <mesh geometry={nodesTyped.card.geometry}>
            ...
            <mesh
              geometry={nodesTyped.clip.geometry}
              material={materialsTyped.metal}
              material-roughness={0.3}
            />
            <mesh
              geometry={nodesTyped.clamp.geometry}
              material={materialsTyped.metal}
            />
          </group>
        </RigidBody>
