...
const RotatingText = forwardRef<HTMLSpanElement, RotatingTextProps>((props, ref) => {
  ...
  return (
    <>
      <motion.span className={cn('text-rotate', mainClassName)} layout transition={transition as never}>
        <span className="text-rotate-sr-only">{texts[currentTextIndex]}</span>
        <AnimatePresence mode={animatePresenceMode as 'sync' | 'wait' | 'popLayout'} initial={animatePresenceInitial}>
          <motion.span
